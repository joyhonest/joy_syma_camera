...
public class Command {
    ...
    public final  static int nLedMax=60;
    public final  static int nLedMax_Set=90;

    public static String  sIP="";
    public static int  DeviceType = 0;    //0 普通   1 LED调光     2 变焦+调光
                                          //3 变焦+调光+G_sensor   4 调光+Gsnesor   5 变焦+调光+SD+Gsensor（GP4225+H264)
...
//                    }
    ...
    public static int nUpgareType=0; // 0 no   1  en   2 jp     3 =
                        ...
                        buffer[7] == 'T' )
                {
                    ...
                    if (buffer[8] == 0x02) { //成功
                        if ((buffer[11] == 0x0) && (buffer[10] == 0x04)) {
                            ...
                            if(aa>15)
                            {
                                SharedPreferences sharedPreferences = MyApp.getSharedPreferences("Tweeze_setup");
                                int nUpgrade = sharedPreferences.getInt("Upgrade", -1);
                                nUpgareType = 0;
//                                v003 FF:  20200827, JH000S, v308
//                                v004 AF:  20200914, JH000S, v309
//                                v005 AF:  20200915, JH000S, v309
//                                v006 FF:  20200916, JH000S, v308
//                                v007 AF:  20201031, JH4B73C, v00
//                                v008 FF:  20201031, JH4B5FC, v00

                                String ver = new String(buffer, 14, aa - 1);
                                String nver = ver.substring(ver.length() - 3);
                                nUpgareType = 0;
                                int  nType =0;
                                if(ver.equals("20200915,JH000S,v309") || ver.equals("20200914,JH000S,v309"))
                                {
                                    //AF 20201031,JH4B73C,v00
                                    nType = 1;
                                    nUpgareType = 3;   //AF
                                }

                                if(ver.equals("20200827,JH000S,v308") || ver.equals("20200916,JH000S,v308"))
                                {
                                    //FF 20201031,JH4B5FC,v00
                                    nType = 2;
                                    nUpgareType = 4;  //FF
                                }
                                ...
                                if(nType==0) {
                                    try {
                                        ...
                                        nUpgareType = 0;
                                        if (nVer == 9) {  // = 9  jp 旧版   11   jp新版     其他的为en版本  09 一下需要升级
                                            nUpgareType = 2;
                                        } else {
                                            if (nVer < 10) {
                                                nUpgareType = 1;
